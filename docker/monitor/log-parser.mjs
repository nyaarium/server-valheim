...
const regexServerReady = /Opened Steam server/g;
const regexPlayerConnected = /Got connection SteamID/g;
const regexPlayerDisconnected = /Closing socket/g;

/**
 * Fixes date format from Valheim server logs
 * @param {string} str - Date string from log (MM/DD/YYYY HH:MM:SS format)
 * @returns {string} Standardized date string
 */
function fixDate(str) {
	// Valheim uses a conventional date format, which is already parseable by Date()
	return str;
}
